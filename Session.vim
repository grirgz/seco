...
badd +220 side.sc
badd +1920 modulation.sc
badd +666 main.sc
badd +51 bindings.sc
badd +86 plop.sc
badd +196 classinstr.sc
...
let s:l = 102 - ((19 * winheight(0) + 19) / 39)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1920 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1920
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1790 - ((18 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1790
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 3201 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3201
