...
badd +1812 side.sc
badd +879 modulation.sc
badd +1059 main.sc
badd +59 bindings.sc
badd +86 plop.sc
badd +527 classinstr.sc
...
let s:l = 346 - ((22 * winheight(0) + 19) / 39)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1055 - ((3 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1055
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1812 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1812
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 789 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
789
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 4282 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4282
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 39 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 710 - ((10 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
710
...
1345
normal zo
let s:l = 860 - ((0 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
860
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 178 - ((0 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
178
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 666 - ((0 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
666
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 176 - ((21 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
176
