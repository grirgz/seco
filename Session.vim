...
badd +1629 side.sc
badd +110 modulation.sc
badd +331 main.sc
badd +41 bindings.sc
badd +2 plop.sc
badd +326 classinstr.sc
badd +1 ~/code/sc/passive/synth.scd
badd +1 ~/code/sc/passive/control.scd
badd +1 wavetable.sc
badd +1 ~/code/sc/passive/main.scd
badd +1 ~/code/sc/passive/paramdata.scd
badd +1 ~/code/sc/passive/ui.scd
args live20.sc
edit live31.sc
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 326 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
326
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 4194 - ((3 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4194
...
1633
normal zo
let s:l = 1633 - ((0 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1633
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1175 - ((3 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1175
