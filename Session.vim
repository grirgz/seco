...
let s:l = 353 - ((38 * winheight(0) + 19) / 39)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 916 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
916
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 3037 - ((0 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3037
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 799 - ((21 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
799
