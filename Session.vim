...
let s:l = 177 - ((11 * winheight(0) + 8) / 17)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1353 - ((4 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1353
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 4505 - ((1 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4505
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 2007 - ((4 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2007
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1946 - ((2 * winheight(0) + 4) / 9)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1946
